...
const GridBackgroundDemo = () => {
  return (
    <div className=" absolute top-0 left-0 h-[110vh] md:h-[100vh] w-[100%] dark:bg-black-100 bg-white dark:bg-grid-white/[0.07] bg-grid-black/[0.2]  flex items-center justify-center">
