  ...
  return (
    <div>
      <div className=" container py-16 grid-cols-2">
        <h1 className=" p-2 text-[1.5rem] font-bold">Testimonials</h1>
        <div className="sm:grid w-full sm:space-y-0 space-y-3 gap-2 sm:grid-cols-12">
          <div className="col-span-4 rounded-md border-[1px] border-gray-300 flex flex-col items-center text-center  p-3 ">
            <img
              src="/imgs/prods/client.png"
              alt=""
              className=" h-[50px] w-[50px] sm:h-[150px] sm:w-[150px] rounded-full bg-[#dfdfdf]"
            />
